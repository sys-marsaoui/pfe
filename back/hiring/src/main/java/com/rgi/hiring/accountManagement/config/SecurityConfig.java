...
public class SecurityConfig {
    ...
    public SecurityConfig(CostomUserDetailsService userDetailsServiceImp, JwtAuthenticationFilter jwtAuthenticationFilter, CustomLogoutHandler logoutHandler) {
